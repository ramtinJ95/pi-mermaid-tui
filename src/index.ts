...
export default function mermaidExtension(pi: ExtensionAPI) {
	pi.registerTool({
		...
		promptGuidelines: [
			...
			"For C4-style architecture views, use render_mermaid with ordinary flat flowchart syntax; encode architectural ownership in node labels rather than subgraphs, prefix labels with Person, System, Container, Component, or External, and label relationships by intent or data flow.",
